...
CS grad student at **HKU**, nerd-sniped by LLM agents and Java backend systems.

```yaml
🎓 currently  : MSc in CS @ HKU
🌱 before     : BUPT, Electronic Information Engineering
🤖 into       : LLM Agents · RAG · MCP · Distributed Systems
...
![PgVector](https://img.shields.io/badge/PgVector-D97757?style=for-the-badge&logoColor=white)
